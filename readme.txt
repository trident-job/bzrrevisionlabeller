...
BZR Revision Labeller is a plugin for CruiseControl.NET that allows you to generate CruiseControl labels for your builds, based upon the revision number of your Subversion working copy.
...
v1.0
* Initial revision ported for Bazaar ported from SvnRevisionLabeller .1.0.32163
